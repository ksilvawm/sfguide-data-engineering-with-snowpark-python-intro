...
DESCRIBE TABLE SNOWPARK_POC_DATA.PUBLIC.ORDER_DETAIL;
SELECT * FROM SNOWPARK_POC_DATA.PUBLIC.ORDER_DETAIL;

DESCRIBE TABLE SNOWPARK_POC_DATA.PUBLIC.LOCATION;
SELECT * FROM  SNOWPARK_POC_DATA.PUBLIC.LOCATION;
